...
// the reports shape (flat report fields), which the plan_runs response
// doesn't carry — a straight prop-fit wasn't possible, so this is the small
// standalone clone the implementation plan calls for. (The external
// cross-post option was removed for #368 — preserved on the demo/aw-share
// branch pending explicit permission.)
