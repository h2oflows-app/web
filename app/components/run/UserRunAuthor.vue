  ...
  <div class="pb-20">
    ...
    <template v-if="!anchorSnap && !anchorSnapping">
      <div class="mb-3 rounded-lg bg-primary-50 dark:bg-primary-950/60 border border-primary-200 dark:border-primary-800 px-3 py-2.5 text-xs text-primary-800 dark:text-primary-200">
        <span class="font-medium">Click river closest to put-in.</span> We'll snap to the nearest NHD flowline. If it picks a nearby tributary or creek, try adjusting your click to a more accurate position along the river you're aiming for.
      </div>
    </template>
    ...
    <div v-if="upComID && !downComID && !gaugeSelectMode" class="mb-3 rounded-lg bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 px-3 py-2 text-xs text-neutral-600 dark:text-neutral-300">
      ...
      <span class="block mt-1 text-neutral-400 dark:text-neutral-500">If it snapped to a nearby tributary or creek instead of your river, try clicking a point further along the main channel. The exact position doesn't need to be perfect — we're just drawing the line. Access points can be added later via the map editor or KML upload.</span>
    </div>
