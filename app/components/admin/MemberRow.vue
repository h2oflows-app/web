<template>
  <div class="flex items-center gap-3 py-2">
    ...
    <div class="flex-1 min-w-0 flex items-center gap-2 flex-wrap">
      <span class="text-sm font-medium text-neutral-800 dark:text-neutral-100 truncate">{{ member.display_name }}</span>
...
import type { RoleMember } from '~/composables/useAdminUsersRoles'
